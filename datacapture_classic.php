<?php
/**
 * Data Capture 经典全页（侧栏 + `js/datacapture.js`）。
 * 默认入口 `datacapture.php` 会 302 到 React `/datacapture`；SPA 顶栏「经典版」指向本页。
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        header('Location: datacapture_classic.php?success=1');
        exit;
    } catch (Exception $e) {
        error_log("Data capture error: " . $e->getMessage());
        header('Location: datacapture_classic.php?error=1');
        exit;
    }
}
                    ...
                    <div class="form-container">
                        ...
                        <form id="dataCaptureForm" class="process-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select id="capture_date" name="capture_date" required>
