...
export default function AccountingDueModal({
  ...
  }, [isOpen, accountingRows.length, updatePopoverPosition]);
  ...
  const popover =
    ...
    createPortal(
      <div
        ref={popoverRef}
        className="accounting-due-inbox-popover accounting-due-inbox-popover--fixed"
        id="processAccountingDuePopover"
        role="dialog"
        aria-label={t("accountingDue")}
        style={{
          top: popoverPos.top,
          left: popoverPos.left,
          width: popoverPos.width,
          ["--accounting-due-caret-left"]: `${popoverPos.caretLeft}px`,
        }}
      >
        <div className="accounting-due-inbox-popover-header">
          <div className="accounting-due-inbox-popover-title">
            {t("accountingDue")}
            <span className="accounting-due-inbox-badge">{postableCount}</span>
          </div>
          <div className="accounting-due-inbox-popover-actions">
            <button
              type="button"
            ...
            <button type="button" className="accounting-due-inbox-btn accounting-due-inbox-close" aria-label={t("close")} onClick={closeInbox}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
        ...
        <div className="accounting-due-inbox-popover-body">
  ...
  return (
    <div className={`process-accounting-inbox-wrap${isOpen ? " process-accounting-inbox-wrap--open" : ""}`} id="processAccountingDueWrap">
      <button
        ref={btnRef}
        type="button"
      ...
      >
        ...
        <svg className="process-accounting-inbox-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" aria-hidden="true">
