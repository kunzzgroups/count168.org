              ...
              groupedRows.map(([currency, rows]) => {
                ...
                return (
                  <div className="member-currency-table-wrapper" key={currency}>
                    ...
                    <div className="member-winloss-table-x-scroll">
                      <table className="transaction-table member-winloss-table member-winloss-table--by-currency">
                        ...
                        <tbody>
                          {rows.length === 0 ? (
                            <tr className="transaction-table-row member-winloss-empty-row">
                              <td className="member-winloss-empty-cell">{t("noData")}</td>
                            </tr>
                          ) : (
                            rows.map((row, idx) => (
                        ...
                        <tfoot>
                          <tr className="transaction-table-row transaction-summary-total">
                            <td className="transaction-summary-total-label">
                              {t("totalRow", { currency })}
                            </td>
                            <td className="transaction-history-col-winloss">
                            ...
                            <td className="transaction-history-col-description" />
                            <td className="transaction-history-col-remark" />
                          </tr>
                        </tfoot>
                      </table>
                    </div>
