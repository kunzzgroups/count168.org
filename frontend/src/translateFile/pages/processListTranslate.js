...
export const PROCESS_LIST_I18N = {
  en: {
    ...
    enterWordsToRemove: "",
    removeWordsHelp: "Commas (,) can separate multiple items. \"=\" removes only an exact full match. ex：ABC → removes ABC from ABC123; =ABC → removes only ABC",
  ...
  zh: {
    ...
    removeWords: "移除词",
    enterWordsToRemove: "",
    removeWordsHelp: "逗号 (,) 可分隔多个内容。「=」仅移除完全相同内容。例：ABC → 移除 ABC123 中的 ABC；=ABC → 仅移除 ABC",
