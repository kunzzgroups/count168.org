...
export const PROCESS_LIST_I18N = {
  en: {
    ...
    enterWordsToRemove: "",
    removeWordsHelp: "Separate multiple items with commas (,). Add \"=\" to remove only an exact full match. Example: ABC removes ABC from ABC123; =ABC removes only ABC.",
  ...
  zh: {
    ...
    removeWords: "移除词",
    enterWordsToRemove: "",
    removeWordsHelp: "可用逗号 (,) 分隔多个内容。加「=」仅移除完整相同内容。例：ABC → 移除 ABC123 中的 ABC；=ABC → 只移除 ABC。",
