...
export const BANK_PROCESS_I18N = {
  en: {
    ...
    errResendLockedPostedToday: "This process already has a transaction posted for this day start today. Delete it from Bank Process Maintenance before resending.",
    resendLockedPostedToday: "A transaction was already posted for this day start today. Delete it from Maintenance to resend.",
  ...
  zh: {
    ...
    errResendLockedPostedToday: "该流程今日已对此起始日入账。请先在 Bank Process Maintenance 删除对应交易后再重发。",
    resendLockedPostedToday: "今日已对此起始日成功入账，请先在 Maintenance 删除对应账单后再重发。",
    resendLockChecking: "正在检查…",
...
const API_MESSAGE_KEYS = {
  ...
  [normApiMessage("This process already has a transaction posted for this Day start today. Delete it from Bank Process Maintenance before resending.")]: "errResendLockedPostedToday",
