...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    removeWordHelp: "Separate multiple items with commas (,). Add \"=\" to remove only an exact full match. Example: ABC removes ABC from ABC123; =ABC removes only ABC.",
  ...
  zh: {
    ...
    enterWordsToRemove: "",
    enterRemark: "输入备注",
    removeWordHelp: "可用逗号 (,) 分隔多个内容。加「=」仅移除完整相同内容。例：ABC → 移除 ABC123 中的 ABC；=ABC → 只移除 ABC。",
