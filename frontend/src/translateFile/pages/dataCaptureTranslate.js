...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    removeWordHelp: "Commas (,) can separate multiple items. \"=\" removes only an exact full match. ex：ABC → removes ABC from ABC123; =ABC → removes only ABC",
  ...
  zh: {
    ...
    enterWordsToRemove: "",
    enterRemark: "输入备注",
    removeWordHelp: "逗号 (,) 可分隔多个内容。「=」仅移除完全相同内容。例：ABC → 移除 ABC123 中的 ABC；=ABC → 仅移除 ABC",
