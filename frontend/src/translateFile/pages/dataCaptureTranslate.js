...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    removeWordHelp: "Comma-separated. Default contains (FREE or NET - WIN - API=). Prefix = for exact token (=XX123). Select all to copy. Saved for this process.",
  ...
  zh: {
    ...
    enterWordsToRemove: "",
    enterRemark: "输入备注",
    removeWordHelp: "逗号分隔。默认包含匹配（如 FREE 或 NET - WIN - API=）；前加 = 为精确整词（如 =XX123）。可全选复制；保存在当前 Process。",
